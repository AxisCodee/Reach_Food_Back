...
class CreateUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'customer_type' => 'required_if:role,customer,in:shop,center',
            // user details
            'image' => 'image|mimes:jpeg,png,jpg,gif,svg|max:2048',
            'address_id' => 'required_if:role,customer,exists:addresses,id',
    ...
    public function messages()
    {
        return [
            ...
            'customer_type.required_if' => 'حقل نوع الزبون مطلوب',
            'address_id.required_if' => 'حقل اختيار المنطقة مطلوب',
        ];
    }
